...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final Map<int, XFile?> _screenshotFileByVendor = {};
  final Map<int, String> _screenshotBase64ByVendor = {};
  final Map<int, String> _paymentTypeByVendor = {};
    ...
    try {
      ...
      setState(() {
        ...
        for (var vId in grouped.keys) {
          ...
          _paymentTypeByVendor[vId] = _paymentTypeByVendor[vId] ?? 'Online';
        }
      });
    } catch (e) {
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (file != null) {
                    ...
                    setState(() {
                      _screenshotFileByVendor[vendorId] = file;
  ...
  bool _areAllPaymentsDone() {
    ...
    for (var vendorId in grouped.keys) {
      final paymentType = _paymentTypeByVendor[vendorId] ?? 'Online';
  ...
  Future<void> _placeOrder() async {
    ...
    if (!_areAllPaymentsDone()) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Please upload UTR and payment screenshot for all sellers with Online payment selected."),
          backgroundColor: AppColors.error,
        ),
      );
      return;
    ...
    try {
      ...
      final response = await ApiService.createOrder(
        ...
        paymentTypeByVendor: _paymentTypeByVendor,
        token: widget.token,
      );
                  ...
                  return Center(
                    child: ConstrainedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          // Left Column (Address, Packages, Remarks)
                          Expanded(
                            flex: 3,
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 24),
                                  _buildMerchantPackagesSection(theme, groupedCart),
                                  const SizedBox(height: 24),
                          ...
                          // Right Column (User Details, Bill Details, Action Button)
                          Expanded(
                            flex: 2,
                            child: SingleChildScrollView(
                              padding: const EdgeInsets.all(24),
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 24),
                                  _buildBillDetailsSection(theme, totalAmount),
                                  const SizedBox(height: 24),
  ...
  Widget _buildMerchantPackagesSection(ThemeData theme, Map<int, List<Map<String, dynamic>>> groupedCart) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text('Payment Method:', style: TextStyle(fontSize: 11.5, color: AppColors.textLight, fontWeight: FontWeight.bold)),
                                  ...
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          setState(() {
                                            _paymentTypeByVendor[vendorId] = 'Online';
                                          });
                                        },
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Online'
                                            ...
                                            border: Border.all(
                                              ...
                                              width: (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Online' ? 1.5 : 1.0,
                                            ),
                                          ),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              Icon(
                                                (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Online'
                                    ...
                                    Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          setState(() {
                                            _paymentTypeByVendor[vendorId] = 'Cash On Delivery';
                                          });
                                        },
                                        borderRadius: BorderRadius.circular(10),
                                        child: Container(
                                          padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 12),
                                          decoration: BoxDecoration(
                                            color: (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Cash On Delivery'
                                                ? theme.colorScheme.primary.withOpacity(0.06)
                                                : Colors.white,
                                            borderRadius: BorderRadius.circular(10),
                                            border: Border.all(
                                              color: (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Cash On Delivery'
                                                  ? theme.colorScheme.primary
                                                  : const Color(0xFFE2E8F0),
                                              width: (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Cash On Delivery' ? 1.5 : 1.0,
                                            ),
                                          ),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              Icon(
                                                (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Cash On Delivery'
                                                    ? Icons.radio_button_checked_rounded
                                                    : Icons.radio_button_off_rounded,
                                                color: (_paymentTypeByVendor[vendorId] ?? 'Online') == 'Cash On Delivery'
                                                    ? theme.colorScheme.primary
                                ...
                                if ((_paymentTypeByVendor[vendorId] ?? 'Online') == 'Online') ...[
                                              ...
                                              ? Stack(
                                                  children: [
                                                    Positioned.fill(
                                                      child: kIsWeb
                                                          ? Image.network(
                                                              _screenshotFileByVendor[vendorId]!.path,
                                                              fit: BoxFit.cover,
                                                            )
                                                          : Image.file(
                                                              File(_screenshotFileByVendor[vendorId]!.path),
                                                              fit: BoxFit.cover,
                                                            ),
                                                    ),
  ...
  Widget _buildBillDetailsSection(ThemeData theme, double totalAmount) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildPlaceOrderButton(ThemeData theme) {
    final hasUtrOrCod = _areAllPaymentsDone();
    final hasAddr = _defaultAddress != null;
    final isButtonEnabled = hasUtrOrCod && hasAddr && !_isSubmittingOrder;
        ...
        child: _isSubmittingOrder
            ...
            : Text(
                ...
                style: TextStyle(
                  fontWeight: FontWeight.w900,
                  fontSize: 16,
                  color: isButtonEnabled ? Colors.white : Colors.white60,
                ),
              ),
      ),
    );
